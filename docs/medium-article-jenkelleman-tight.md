...
## Why this category of bug matters
...
This one happened to be a PDF export. The pattern is much bigger.

Systems can appear stable until real-world use reveals where they offload complexity and risk onto the user.
